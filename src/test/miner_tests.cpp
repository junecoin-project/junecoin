...
static void TestPackageSelection(const CChainParams& chainparams, const CScript& scriptPubKey, const std::vector<CTransactionRef>& txFirst) EXCLUSIVE_LOCKS_REQUIRED(cs_main, ::mempool.cs)
{
    ...
    tx.vout.resize(1);
    tx.vout[0].nValue = 5000000000000LL - 1000;
    ...
    tx.vout[0].nValue = 5000000000000LL - 1000 - 50000; // 0 fee
    ...
    tx.vout[0].nValue = 5000000000000LL - 1000 - 50000 - feeToUse;
    ...
    tx.vout.resize(2);
    tx.vout[0].nValue = 5000000000000LL - 100000000;
    ...
    tx.vout[0].nValue = 5000000000000LL - 100000000 - feeToUse;
...
//BORIS - TODO - BACK WHEN WE HAVE ENOUGH 100 blocks sample

...
const char * const BITCOIN_CONF_FILENAME = "junecoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "JuneCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/JuneCoin";
#else
    // Unix
    return pathRet / ".junecoin";
#endif
#endif
}

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " junecoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  junecoin-tx [options] <hex-tx> [commands]  Update hex-encoded junecoin transaction\n" +
            "or:     junecoin-tx [options] -create [commands]   Create hex-encoded junecoin transaction\n" +
            "\n";

# Support for Output Descriptors in JuneCoin Core

Since JuneCoin Core v0.17, there is support for Output Descriptors. This is a
...
on JuneCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing JuneCoin Core wallets, a convenience function `combo` is

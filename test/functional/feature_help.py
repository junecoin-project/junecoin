...
"""Verify that starting junecoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start junecoin with -h for help text")
        ...
        self.log.info("Start junecoin with -version for version information")
        ...
        self.log.info("Start junecoind with -fakearg to make sure it does not start")
